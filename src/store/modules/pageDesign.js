...
const actions = {
  setCheckImgIds (store, imgList) {
    store.state.dImgList = imgList
  },
  getStoreImgList (store) {
    return store.state.dImgList
  },
  setPosterList (store, posterList) {
    store.state.dPosterList = posterList
  },
  getPosterList (store) {
